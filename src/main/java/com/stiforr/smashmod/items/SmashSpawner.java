package com.stiforr.smashmod.items;
...
public class SmashSpawner extends Item {
    public SmashSpawner(){
        setUnlocalizedName("smashSpawner");
        setCreativeTab(CreativeTabSmash.Smash_Tab);
    }
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    EntitySmash jeep = new EntitySmash(world, i + 0.5, j + 1.0F,k + 0.5);
